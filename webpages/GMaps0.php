...
<h1 id=header>LocatIot Tracker v. 0.1a (EARLY ACCESS BUILD)</h1>
  <body>
    ...
    <button type=button id=centerOuluBtn onclick="centerOulu()">Default Center Map</button>
    ...
    <script>
        ...
        var lastPoint;
        var dLatitude = 64.9973158;
        var dLongitude = 25.4867483;
     ...
     function centerOulu() {
        var dPoint = new google.maps.LatLng(dLatitude, dLongitude);
        map.getMap();
        map.setCenter(dPoint);
      }
